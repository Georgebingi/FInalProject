        ...
        <div style={styles.resourcesGrid}>
          <div style={styles.resourceCard}>
            ...
            <div style={{marginTop: "10px", display: "flex", alignItems: "center", justifyContent: "center" }}>
              ...
              <button onClick={() => handleNavigate("/studentsmentormind")}  style={{ ...styles.button, ...styles.greenButton }}>
          ...
          <div style={styles.resourceCard}>
                ...
                <div style={{marginTop: "10px", display: "flex", alignItems: "center", justifyContent: "center" }}>
                    ...
                    <div style={{ width: "1px", height: "20px", backgroundColor: "#C6CDD5", margin: "0 10px" }} />
                    <button onClick={() => handleNavigate("/studentscounselorsession")}  style={{ ...styles.button, ...styles.blueButton }}>
            ...
            <div style={styles.resourceCard}>
                ...
                <div style={{marginTop: "10px", display: "flex", alignItems: "center", justifyContent: "center" }}>
                    ...
                    <div style={{ width: "1px", height: "20px", backgroundColor: "#C6CDD5", margin: "0 10px" }} />
                    <button style={{ ...styles.button, ...styles.blackButton }}>
