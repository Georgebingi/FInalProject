...
const ChatHistory = () =>{
    ...
    const chatData = [
        { id: 1, name: "Being better at school", message: "I think you should focus more on what's ahead and work harder", notification: "2:32 pm" },
        { id: 2, name: "Being better at school", message: "I think you should focus more on what's ahead and work harder", notification: "2:32 pm" },
        { id: 3, name: "Being better at school", message: "I think you should focus more on what's ahead and work harder", notification: "2:32 pm" },
        { id: 4, name: "Being better at school", message: "I think you should focus more on what's ahead and work harder", notification: "2:32 pm" },
      ]
    ...
    return(
        <div style={{...styles.container}}>
            <div style={{display: "flex", 
                ...
                <h1 style={{fontWeight:"500px", fontFamily:"Manrope", textAlign: "left", fontSize:"60px"}}>Chat History</h1>
                ...
                alt="Image"/>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "10px", justifyContent: "space-between" }}>
                      <h2 style={{...styles.headerTitle, fontWeight:"500px", fontFamily:"Manrope",}}>MENTORMIND AI</h2>
