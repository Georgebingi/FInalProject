      ...
      <div style={{...styles.container}}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center"}}>
            ...
            <div style={{position: "relative"}}>
              <button style={{
                ...
                lineHeight: "120%",
                letterSpacing: "-2%",
              }} onClick={() => handleNavigate("/messagerequest")}>
        ...
        <div style={styles.chatBox}>
          ...
          >
            ...
            >anonymously</span> with an avaliable student?
          </p>
          <div onClick={() => handleNavigate("/studentchat")}
        ...
        <div style={styles.bookSessioncontainer}>
          <div style={{ display: "flex", alignItems: "center", gap: "10px", justifyContent: "space-between" }}>
            <h2 style={styles.headerTitle}>Student Sessions</h2>
          ...
          <div style={styles.chatHistory}>
            ...
            <div key={chat.id} style={styles.chatItem}>
              ...
              <div onClick={() => handleNavigate("/chatui")}
